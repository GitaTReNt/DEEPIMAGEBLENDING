...
from utils import *
import locate_xy_starts
from locate_xy_starts import Clickchoose
# File Inputs
idx = 5
...
#x_start = 382; y_start = 300 # blending location取决于手动
x_start,y_start = Clickchoose(target_file)#xstart ystart相当于目标图像融合点的中心坐标
...
mask_img = np.array(Image.open(mask_file).convert('L').resize((ss, ss)))#maskfile就是sourcefile的黑白二值化 ss是blending的尺寸
